...
class Group_dosen extends MY_Model
{
    ...
    protected $order = array('groupID' => 'desc');

	public function __construct()
	{
        $this->table = 'group_dosen';
	...
	private function _get_datatables_query()
    {
        ...
        $this->db->join('programstudi', 'programstudi.prodiID=group_dosen.prodiID', 'LEFT');
