    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                <div class="inner">
                    <h3><?php //echo isset($count_customers) ? $count_customers : 0; ?></h3>
                    <p>Customers</p>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-green">
                <div class="inner">
                    <h3><?php //echo isset($count_suppliers) ? $count_suppliers : 0; ?></h3>
                    <p>Suppliers</p>
                </div>
                <div class="icon">
                    <i class="ion ion-stats-bars"></i>
                </div>
                <a href="<?php echo site_url('suppliers'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
        </div><!-- ./col -->
        <div class="col-lg-3 col-xs-6">
            <!-- small box -->
        ...
        <div class="small-box bg-red">
            <div class="inner">
                <h3><?php //echo isset($count_data) ? $count_data : 0; ?></h3>
                <p>Dumy Data</p>
            </div>
            <div class="icon">
                <i class="ion ion-pie-graph"></i>
            </div>
            <a href="<?php echo site_url('data'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
        </div>
        </div><!-- ./col -->
    </div><!-- /.row -->
    <!-- Main row -->
