				...
				<div id="table-data">
					<div class="box-body">
						<div class="form-group">
							<div class="row">
								<div class="col-lg-6">
									<button id="create" class="btn btn-primary btn-sm" title="Data Create" alt="Data Create"><i class="glyphicon glyphicon-plus"></i> Tambah Dosen Kelas</button>
									<button id="create-many" class="btn btn-success btn-sm" title="Data Create" alt="Data Create"><i class="glyphicon glyphicon-plus"></i> Tambah Banyak Dsn Kelas</button>
									<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-import"></i>Import Dosen Kelas</button>
								</div>
							</div>
						</div>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Import Dosen Kelas</h4>
				</div>
				...
				<div class="modal-footer">
					<a href="<?php echo base_url() . 'index.php/DsnKelas/export'; ?>" class="btn btn-success">Example Data Import Dosen Kelas</a>
...
<script type="text/javascript">
	var site_url = site_url() + 'DsnKelas/';
