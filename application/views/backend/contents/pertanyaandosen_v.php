        ...
        <div id="table-data">
            <div class="box-body">
                <div class="form-group">
                    <div class="row">
                        <div class="col-lg-6">
                            <button id="create" class="btn btn-primary btn-sm" title="Data Create" alt="Data Create" ><i class="glyphicon glyphicon-plus"></i> Tambah Pertanyaan Dosen</button>
                            <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"><i class="glyphicon glyphicon-import"></i>Import Pertanyaan Dosen</button>
                        </div>  
                    </div>
                </div>  
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Import Pertanyaan Dosen</h4>
      </div>
      ...
      <div class="modal-footer">
        <a href="<?=base_url()?>assets/download/pertanyaandosen.xlsx" class="btn btn-success">Example Data Import Pertanyaan Dosen</a>
...
<script type="text/javascript">
    var site_url = site_url() + 'pertanyaandosen/';
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({ 
            ...
            "ajax": {
                "url": site_url + 'get_pertanyaandosen',
                "type": "POST"
            },
        ...
        $('#create').click(function() {
            $.ajax({
                ...
                success: function(data){
                    ...
                    form_data();
                    $('.box-title').text('Create Pertanyaan Dosen');  
        ...
        $('#submit').click(function() {
            $.ajax({
                url : site_url + 'save_pertanyaandosen/',
                type: "POST",
    ...
    {    
        ...
        $('.box-title').text('Pertanyaan Dosen List'); 
    }
    ...
    function form_view()
    {
        ...
        $('.box-title').text('View Pertanyaan Dosen'); 
    }
    ...
    function update_data(id)
    {
         $.ajax({
            ...
            success: function(data){
                $(".chosen-select").chosen("destroy");
                form_data();
                $('.box-title').text('Update Pertanyaan Dosen'); 
