...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 01, 2020 at 06:21 PM
...
INSERT INTO `group_pertanyaan` (`groupID`, `prodiID`, `nama`, `jawaban`, `nilai`, `created_at`, `updated_at`) VALUES
(122222, 14001, 'Sarana dan Prasarana', 'Kurang,Cukup,Baik,Sangat Baik', '1, 2, 3, 4, 5', '2020-01-01 14:52:50', '2020-01-01 14:54:32'),
(364353, 14001, 'Pelayanan Pendidikan', 'Kurang,Cukup,Baik,Sangat Baik', '1, 2, 3, 4, 5', '2020-01-01 21:25:15', '0000-00-00 00:00:00'),
(367453, 14001, 'Proses Skripsi / Tugas Akhir', 'Kurang,Cukup,Baik,Sangat Baik', '1, 2, 3, 4, 5', '2020-01-01 21:25:15', '0000-00-00 00:00:00'),
(525255, 14001, 'Evaluasi Kinerja Dosen', 'Sangat Tidak Setuju, Tidak Setuju, Ragu-ragu, Setuju, Sangat Setuju', '1, 2, 3, 4, 5', '2020-01-01 18:01:23', '0000-00-00 00:00:00');
...
('12171568', 'Muhammad Alvian Rizky', '13201', '2017', '2019-12-15 00:00:00', '2020-01-01 08:54:47'),
...
INSERT INTO `pertanyaan` (`pertanyaanID`, `groupID`, `pertanyaan`, `created_at`, `updated_at`) VALUES
(231313, 122222, 'Ruang pembelajaran yang bersih, nyaman dan rapi', '2020-01-01 16:01:05', '0000-00-00 00:00:00'),
(536241, 122222, 'Institusi mempunyai laboratorium yang relevan dengan kebutuhan keilmuan bidang di program studi ( Keperawatan, Kesehatan Masyarakat, Farmasi)', '2020-01-02 00:12:36', '0000-00-00 00:00:00'),
(564544, 122222, 'Institusi menyediakan sarana pembelajaran yang memadai diruang kuliah (Kipas, LCD, White board, sound, mix dll)', '2020-01-02 00:12:36', '0000-00-00 00:00:00');
...
INSERT INTO `pertanyaandosen` (`pertanyaanID`, `groupID`, `pertanyaan`, `created_at`, `updated_at`) VALUES
(123123, 525255, 'Dosen menyampaikan RPS (Rencana Pembelajaran Semester)/Silabus/SAP (Satuan Acara Pembelajaran) di awal perkuliahan', '2020-01-01 18:06:03', '0000-00-00 00:00:00'),
(123456, 525255, 'Menyediakan/memberikan bahan ajar diluar buku rujukan (handout/transparan sheet/power point slide) yang cukup jelas untuk setiap materi', '2020-01-02 00:14:30', '0000-00-00 00:00:00'),
(341413, 525255, 'Dosen memberikan informasi mengenai buku teks atau rujukan yang digunakan', '2020-01-02 00:14:30', '0000-00-00 00:00:00');
...
INSERT INTO `programstudi` (`prodiID`, `nama_prodi`, `jenjang`, `user_id`, `created_at`, `updated_at`, `status`) VALUES
(13201, 'Kesehatan Masyarakat', 'S1', 1, '2015-09-06 10:08:02', '2020-01-01 00:33:14', b'1'),
...
(1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, 'q/NpS9LmynsSThxU6XccdO', '2020-01-01 20:02:38', '2020-01-01 14:02:38', 1, 'Admin', 'istrator', 'ADMIN', '0');
...
--
-- Indexes for table `group_pertanyaan`
--
ALTER TABLE `group_pertanyaan`
...
--
-- Indexes for table `pertanyaandosen`
--
ALTER TABLE `pertanyaandosen`
  ADD PRIMARY KEY (`pertanyaanID`);
